...
Data Loading and Inspection: Loads the dataset and checks for missing values or duplicates (no duplicates were found).

Feature Engineering: A new feature, Energy Quality Score, is calculated as the difference between the Renewable Energy Share (%) and the Fossil Fuel Dependency (%). This score helps in quickly assessing a country's energy sustainability.

Exploratory Data Analysis (EDA): Visualizations are generated to understand distributions and relationships between variables like.
